...
$(document).ready(function() {
    ...
    function moving_clouds(){
        var x = document.getElementById('moving1');
        var y = document.getElementById('moving2');
        x.style.left = left + 'px';
        y.style.left = 1.5*left + 100 + 'px';
        left += 1;
        if(left>2000){
            left=-100;
        }
